...
export class UserBlacklistComponent implements OnInit, OnDestroy {
  ...
  getDbData() {
    return new Promise((resolve, reject) => {
      this.data = [];
      this.usernameService.get('blacklist').subscribe((res) => {
        this.data = res.data;
        resolve(res);
      });
    });
  ...
  onEditRaw(id) {
    ...
    delete new_data.id;
    this.usernameService.put(`blacklist/${id}`, new_data).subscribe((res) => {
